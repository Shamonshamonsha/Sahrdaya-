            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    ...
                    <div style="float:right; margin-top: -20px">
                        ...
                        if($value->status=='5'){
                            ...
                            echo '<strong style="color: #c9302c">Forward to Secretary</strong>';
                        }
                        ?>
                    </div>
                </div>
                <div id="collapse<?=$key?>" class="panel-collapse collapse">
                    <div class="panel-body">
                        ...
                        <?php if($value->totalbuild_area>='750'&&$value->totalbuild_area<1500){ ?>
                            <div class="row">
                                <a style="float: right" href="<?=base_url().'common/approve_appee/'.$value->id?>" class="btn btn-primary <?php if($value->status=='3')echo 'disabled';?>">Approve</a>
                            </div>
                        <?php } else {?>
                            <a style="float: right" href="<?=base_url().'common/forward_ee/'.$value->id?>" class="btn btn-primary <?php if($value->status=='6')echo 'disabled';?>">Forward to Secretary</a>
                            <br>
                        <?php }?>
                        <br>
                        <div class="row">
